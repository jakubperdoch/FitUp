      ...
      {isFetchingData ? (
        ...
        >
          <View className="flex-row items-center flex-wrap justify-between gap-6 border-b border-[#E5E6E6] pb-7 ">
            <Text className="font-poppins text-lg">Calories (kCal)</Text>
            <Controller
              defaultValue={""}
              control={control}
              render={({ field: { onChange, value } }) => (
                <Input size="xl" variant="rounded" className="max-w-40 flex-1">
                  <InputField
                    className="text-lg"
                    value={value}
                    inputMode={"decimal"}
          ...
          <View className="flex-row items-center flex-wrap justify-between gap-4 border-b border-[#E5E6E6] pb-7 ">
            <Text className="font-poppins text-lg">Protein (g)</Text>
            <Controller
              control={control}
              render={({ field: { onChange, value } }) => (
                <Input size="xl" variant="rounded" className="max-w-40 flex-1">
          ...
          <View className="flex-row flex-wrap justify-between items-center gap-6 border-b border-[#E5E6E6] pb-7 ">
            <Text className="font-poppins text-lg">Carbohydrates (g)</Text>
            <Controller
              control={control}
              render={({ field: { onChange, value } }) => (
                <Input size="xl" variant="rounded" className="max-w-40 flex-1">
          ...
          <View className="flex-row items-center flex-wrap justify-between gap-6 border-b border-[#E5E6E6] pb-7 ">
            <Text className="font-poppins text-lg">Fats (g)</Text>
            <Controller
              control={control}
              render={({ field: { onChange, value } }) => (
                <Input size="xl" variant="rounded" className="max-w-40 flex-1">
          ...
          <View className="flex-row items-center flex-wrap justify-between gap-6 border-b border-[#E5E6E6] pb-7 ">
            <Text className="font-poppins text-lg">Sugar (g)</Text>
            <Controller
              control={control}
              render={({ field: { onChange, value } }) => (
                <Input size="xl" variant="rounded" className="max-w-40 flex-1">
          ...
          <View className="flex-row items-center flex-wrap justify-between gap-6 ">
            <Text className="font-poppins text-lg">Fiber (g)</Text>
            <Controller
              control={control}
              render={({ field: { onChange, value } }) => (
                <Input size="xl" variant="rounded" className="max-w-36 flex-1">
                  <InputField
                    className="text-lg"
                    value={value}
                    inputMode={"decimal"}
