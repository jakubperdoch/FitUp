...
class WorkoutExercise extends Model
{
    ...
    {
        return $this->hasMany(WorkoutSet::class, 'workout_exercise_id')->orderBy('order_index');
    }

    public function exercises()
    {
        return $this->hasMany(WorkoutExercise::class, 'parent_exercise_id')->orderBy('order_index');
    }
